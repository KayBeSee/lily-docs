...
import { Rocket, Book, DesktopDownload, Gift, CodeReview } from '@styled-icons/octicons';
...
export default function IndexPage() {
  return (
    <Fragment>
      <img className="h-20 w-auto mx-auto mt-4" src="/assets/logo.svg" alt="Lily Logo" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        <Card
          image={<RocketIcon className="bg-green-100 rounded-full text-green-900" />}
          link="/overview"
          title="Get Started"
        ...
        <Card
          image={<DesktopDownloadIcon className="bg-green-100 rounded-full text-green-900" />}
          link="/installation"
        ...
        <Card
          image={<BookIcon className="bg-green-100 rounded-full text-green-900" />}
          link="/guides"
          title="Guides"
        ...
        <Card
          image={<GiftIcon className="bg-green-100 rounded-full text-green-900" />}
          link="/get-started"
          title="What's new?"
        ...
        <Card
          image={<CodeReviewIcon className="bg-green-100 rounded-full text-green-900" />}
          link="/get-started"
          title="Developers"
