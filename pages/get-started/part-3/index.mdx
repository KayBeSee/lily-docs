...
<img alt="Input account name in Lily Wallet" src={SelectHardwareWallets} />
...
<img alt="Input account name in Lily Wallet" src={SelectRequiredSigners} />
...
<img alt="Input account name in Lily Wallet" src={Success} />
